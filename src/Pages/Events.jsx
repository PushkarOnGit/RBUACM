      ...
      <div className={styles.timeline}>
        ...
        <div className="container left-container">
          ...
          <div className="text-box htmlcard">
            ...
            <p>
              ...
              in HTML. They developed responsive, accessible web pages,
              optimized performance, and ensured cross-browser compatibility for
        ...
        <div className="container right-container">
          ...
          <div className="text-box javascriptcard">
            ...
            <p>
              ...
              JavaScript. They developed interactive web applications, optimized
              code for performance, and implemented dynamic features to enhance
              user engagement.
            </p>
        ...
        <div className="container left-container">
          ...
          <div className="text-box reactjscard">
            ...
            <p>
              ...
              building scalable single-page applications, creating reusable
              components, and managing state for improved performance and user
              experience.
            </p>
        ...
        <div className="container left-container">
          ...
          <div className="text-box expressjscard">
            ...
            <p>
              MR Coder has 1 year of experience at [Company Name], focusing on
              Express.js. They built and maintained RESTful APIs, handled
              server-side routing, and ensured efficient application performance
              and scalability.
            </p>
        ...
        <div className="container right-container">
          ...
          <div className="text-box mongodbcard">
            ...
            <p>
              ...
              MongoDB. They managed databases, designed schemas, and optimized
              queries to ensure efficient data storage and retrieval for
              applications.
            </p>
        ...
        <div className="container left-container">
          ...
          <div className="text-box phpcard">
            ...
            <p>
              ...
              in PHP. They developed server-side scripts, built dynamic web
              applications, and integrated databases to enhance functionality
